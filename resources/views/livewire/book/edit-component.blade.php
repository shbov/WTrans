<x-jet-form-section submit="update">
    ...
    <x-slot name="form">
        <div class="col-span-6 sm:col-span-3">
            ...
            <select id="category_id" wire:model.defer="book.category_id" autocomplete="category_id" class="border-gray-300 focus:border-indigo-300
                ...
                <option value="undefined" disabled>Выбрать категорию</option>
        ...
        <div class="col-span-6 sm:col-span-3">
            ...
            <select id="team_id" wire:model.defer="book.team_id" autocomplete="team_id" class="border-gray-300 focus:border-indigo-300
                focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full">
                <option value="null" disabled selected="selected">Выбрать команду</option>
    ...
    <x-slot name="actions">
        <a href="{{ route('books.show', $book->id) }}"
           class="ont-semibold text-xs uppercase tracking-widest mr-3">Вернуться назад</a>
        <x-jet-button wire:loading.attr="disabled" wire:keydown.enter="update">
            {{ __('Сохранить') }}
        </x-jet-button>
    </x-slot>
</x-jet-form-section>
